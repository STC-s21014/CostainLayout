package com.example.mycostainlayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btSend.setOnClickListener((View.OnClickListener) listener);
    ...
    private class BtListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            EditText inMailTitle = findViewById(R.id.etMtitle);
            EditText inComment = findViewById(R.id.editTextTextMultiLine);
